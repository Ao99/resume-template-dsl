...
public class Resume_templatePackageImpl extends EPackageImpl implements Resume_templatePackage {
	 ...
	 */
	@Override
	public EAttribute getResumeTemplate_DefaultSize() {
	 ...
	 */
	@Override
	public EAttribute getTextElement_Size() {
	 ...
	 */
	@Override
	public EAttribute getHorizontalLine_Size() {
	...
	public void createPackageContents() {
		...
		createEAttribute(resumeTemplateEClass, RESUME_TEMPLATE__DEFAULT_SIZE);
		...
		createEAttribute(textElementEClass, TEXT_ELEMENT__SIZE);
		...
		createEAttribute(horizontalLineEClass, HORIZONTAL_LINE__SIZE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getResumeTemplate_DefaultSize(), ecorePackage.getEDouble(), "defaultSize", "11", 0, 1, ResumeTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTextElement_Size(), ecorePackage.getEDouble(), "size", null, 0, 1, TextElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getHorizontalLine_Size(), ecorePackage.getEDouble(), "size", "5", 0, 1, HorizontalLine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
