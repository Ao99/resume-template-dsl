 ...
 *   <li>{@link resume_template.impl.TextElementImpl#getFontSize <em>Font Size</em>}</li>
...
public abstract class TextElementImpl extends ElementImpl implements TextElement {
	...
	public void setFontSize(double newFontSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Resume_templatePackage.TEXT_ELEMENT__FONT_SIZE, oldFontSize, fontSize));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Resume_templatePackage.TEXT_ELEMENT__FONT:
				return getFont();
			case Resume_templatePackage.TEXT_ELEMENT__FONT_SIZE:
				return getFontSize();
