 ...
 * @generated
 */
public class Resume_templateSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Resume_templatePackage.RESUME_TEMPLATE: {
				ResumeTemplate resumeTemplate = (ResumeTemplate)theEObject;
				T result = caseResumeTemplate(resumeTemplate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Resume_templatePackage.THEME_COLOR: {
				ThemeColor themeColor = (ThemeColor)theEObject;
				T result = caseThemeColor(themeColor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Resume_templatePackage.ELEMENT: {
			...
			case Resume_templatePackage.PARAGRAPH: {
				Paragraph paragraph = (Paragraph)theEObject;
				T result = caseParagraph(paragraph);
				if (result == null) result = caseTextElement(paragraph);
				if (result == null) result = caseElement(paragraph);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Resume_templatePackage.LIST: {
				List list = (List)theEObject;
				T result = caseList(list);
				if (result == null) result = caseTextElement(list);
				if (result == null) result = caseElement(list);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Resume_templatePackage.TABLE: {
			...
			case Resume_templatePackage.CELL: {
				Cell cell = (Cell)theEObject;
				T result = caseCell(cell);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Resume_templatePackage.HORIZONTAL_LINE: {
				HorizontalLine horizontalLine = (HorizontalLine)theEObject;
				T result = caseHorizontalLine(horizontalLine);
				if (result == null) result = caseElement(horizontalLine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Resume Template</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Resume Template</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseResumeTemplate(ResumeTemplate object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Theme Color</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Theme Color</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseThemeColor(ThemeColor object) {
		return null;
	}
